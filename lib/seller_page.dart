...
final Color cardDark  = const Color(0xFF141414); // card gelap
  ...
  Future<void> _create() async {
    ...
    final res = await http.get(Uri.parse(
        "https://panel-private-yanz.fansjkt48.web.id:10918/createAccount?key=${widget.keyToken}&newUser=$u&pass=$p&day=$d"));
  ...
  Future<void> _edit() async {
    ...
    setState(() => loading = true);
    final res = await http.get(Uri.parse(
        "https://panel-private-yanz.fansjkt48.web.id:10918/editUser?key=${widget.keyToken}&username=$u&addDays=$d"));
    final data = jsonDecode(res.body);
    if (data['edited'] == true) {
