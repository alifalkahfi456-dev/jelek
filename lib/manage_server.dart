...
class _ManageServerPageState extends State<ManageServerPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://yanzoffc-private.panelwota.my.id:11396/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://yanzoffc-private.panelwota.my.id:11396/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    ...
    final uri = Uri.parse('http://yanzoffc-private.panelwota.my.id:11396/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
