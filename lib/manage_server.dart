...
class _ManageServerPageState extends State<ManageServerPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchVpsList() async {
    ...
    final uri = Uri.parse('http://putrapedia.pteroqdactyl.my.id:11529/myServer?key=${widget.keyToken}');
    try {
  ...
  Future<void> _addVps() async {
    ...
    final uri = Uri.parse('http://putrapedia.pteroqdactyl.my.id:11529/addServer');
    try {
  ...
  Future<void> _deleteVps(String host) async {
    ...
    final uri = Uri.parse('http://putrapedia.pteroqdactyl.my.id:11529/delServer');
    try {
      final res = await http.post(uri, body: {
        'key': widget.keyToken,
        'host': host,
