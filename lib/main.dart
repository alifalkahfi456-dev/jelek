...
// ─────────────────────────────────────────────
class _C {
  static const bg        = Color(0xFF06131A);   // was 0xFF050A12
  static const surface   = Color(0xFF0C1D26);   // was 0xFF0A1525
  static const card      = Color(0xFF122833);   // was 0xFF0E1E35
  static const border    = Color(0xFF2B5D6A);   // was 0xFF162B4A
  static const borderLit = Color(0xFF3A7685);   // was 0xFF1E3F6E

  static const steel     = Color(0xFF2FA9B8);   // was 0xFF1A4F8A
  static const blueMid   = Color(0xFF39C7D9);   // was 0xFF2370BE
  static const blueLight = Color(0xFF5EEFFF);   // was 0xFF4A94E8
  static const chrome    = Color(0xFF67DDE2);   // was 0xFF7AB4E8
  static const frost     = Color(0xFFB7FFF7);   // was 0xFFADD4F5

  static const green     = Color(0xFF55D6C2);   // tetap hijau-cyan
  static const amber     = Color(0xFF79E6E6);   // warning soft cyan
  static const red       = Color(0xFF4CD4D8);   // accent cyan terang

  static const text      = Color(0xFFEFFFFF);   // was 0xFFDEEEFB
  static const textSub   = Color(0xFFA8D7DF);   // was 0xFF6A92B8
  static const textDim   = Color(0xFF6F95A0);   // was 0xFF2E4E6E

  static const LinearGradient metalGrad = LinearGradient(
    colors: [Color(0xFF1A4A55), Color(0xFF39C7D9), Color(0xFF7CF7ED)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const LinearGradient surfaceGrad = LinearGradient(
    colors: [Color(0xFF0C1D26), Color(0xFF122833)],
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
  );

  static const LinearGradient bgGrad = LinearGradient(
    colors: [Color(0xFF06131A), Color(0xFF0C1D26)],
