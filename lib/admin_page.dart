...
// ─── Palette: Biru Modern (sama dengan LoginPage & LandingPage) ─────────────
class _C {
...
class _AdminPageState extends State<AdminPage>
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse(
            'http://tirzzmalesddos.sano.biz.id:11478/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          'http://tirzzmalesddos.sano.biz.id:11478/deleteUser?key=$sessionKey&username=$username'));
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          'http://tirzzmalesddos.sano.biz.id:11478/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole'));
      final data = jsonDecode(res.body);
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isError
                  ...
                  : _C.blueLight.withOpacity(0.4),
              width: 1.5,
            ),
            boxShadow: [
              BoxShadow(
                color: (isError ? _C.red : _C.blueLight)
                    .withOpacity(0.15),
                blurRadius: 40,
                spreadRadius: 0,
              ),
            ...
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  color: isError ? _C.red : _C.blueAccent,
                  size: 26,
                ),
              ),
              ...
              Text(message,
                  ...
                  style: const TextStyle(
                      color: _C.textSub, fontSize: 14, height: 1.5)),
      ...
      pageBuilder: (ctx, _, __) => Dialog(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(20),
            border:
                Border.all(color: _C.red.withOpacity(0.35), width: 1.5),
            boxShadow: [
              BoxShadow(
  ...
  Widget _buildButton({
    ...
    final Color baseColor = isDestructive ? _C.red : _C.blueLight;
        ...
        child: AnimatedContainer(
          ...
          child: loading
              ...
              : Row(
                  ...
                  children: [
                    if (icon != null) ...[
                      Icon(icon, size: 16, color: _C.text),
                      const SizedBox(width: 8),
                    ],
                    Text(
                      label,
                      style: TextStyle(
                        color: isOutline ? _C.textSub : _C.text,
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          floatingLabelStyle:
              const TextStyle(color: _C.blueLight, fontSize: 12),
          prefixIcon:
              Icon(icon, color: _C.textDim, size: 18),
          filled: true,
        ...
        children: [
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton<String>(
              ...
              icon:
                  const Icon(Icons.expand_more, color: _C.textSub, size: 20),
              style: const TextStyle(
                  color: _C.text,
                  fontSize: 14,
  ...
  Widget _buildSection({
    ...
    final color = accentColor ?? _C.blueLight;
    return Container(
  ...
  Widget _badge(String label) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: _C.blueDark.withOpacity(0.3)),
      ),
      child: Text(label,
          style: const TextStyle(
              color: _C.blueAccent, fontSize: 10, fontWeight: FontWeight.w600)),
    );
  }
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                    color: _C.blueLight.withOpacity(0.4 * _pulse.value)),
                boxShadow: [
                  BoxShadow(
                    color: _C.blueLight.withOpacity(0.2 * _pulse.value),
                    blurRadius: 16,
                  ),
                ],
              ),
    ...
    return Row(
      children: [
        _buildStatCard('Total User', '$totalAll',
            Icons.people_outline_rounded, _C.blueLight),
        const SizedBox(width: 10),
        _buildStatCard('Reseller', '$totalReseller',
            Icons.storefront_outlined, _C.green),
        const SizedBox(width: 10),
        _buildStatCard('Member', '$totalMember',
            Icons.person_outline_rounded, _C.blueAccent),
      ],
    );
  }
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(label,
                style:
                    const TextStyle(color: _C.textSub, fontSize: 10)),
          ],
        ),
      ),
    );
  ...
  Widget _buildEmptyState() {
    return Padding(
      ...
      child: Column(
        children: [
          Icon(Icons.inbox_outlined, color: _C.textDim, size: 40),
