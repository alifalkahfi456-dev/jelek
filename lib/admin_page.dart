...
class _AdminPageState extends State<AdminPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://senzlinodepriv.senzhosting.my.id:11016/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://senzlinodepriv.senzhosting.my.id:11016/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final url = Uri.parse(
        'http://senzlinodepriv.senzhosting.my.id:11016/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
