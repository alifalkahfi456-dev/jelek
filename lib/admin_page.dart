...
class _AdminPageState extends State<AdminPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://putrapedia.pteroqdactyl.my.id:11529/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(
        Uri.parse('http://putrapedia.pteroqdactyl.my.id:11529/deleteUser?key=$sessionKey&username=$username'),
      );
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final url = Uri.parse(
        'http://putrapedia.pteroqdactyl.my.id:11529/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole',
      );
