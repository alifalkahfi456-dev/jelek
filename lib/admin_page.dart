...
class _AdminPageState extends State<AdminPage>
  ...
  final List<String> roleOptions = ['full_up', 'reseller', 'vip', 'owner', 'high_owner', 'founder'];
...
// ─── Warna Biru Tua Metalik Modern ───────────────────────────────────────
  static const Color bgBase      = Color(0xFF06131A);
  static const Color bgSurface   = Color(0xFF0C1D26);
  static const Color bgCard      = Color(0xFF122833);
  static const Color borderColor = Color(0xFF2B5D6A);
  static const Color primary     = Color(0xFF39C7D9);
  static const Color primaryLit  = Color(0xFF5EEFFF);
  static const Color accent      = Color(0xFF67DDE2);
  static const Color accentGlow  = Color(0xFFB7FFF7);
  static const Color textPrimary = Color(0xFFEFFFFF);
  static const Color textMuted   = Color(0xFF7FA5AF);
  static const Color textSub     = Color(0xFFA8D7DF);
  ...
  Future<void> _fetchUsers() async {
    ...
    try {
      final res = await http.get(
        Uri.parse(
            'http://tirzzadminbaik.pteroqdactyl.my.id:11560/listUsers?key=$sessionKey'),
      );
  ...
  Future<void> _deleteUser() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          'http://tirzzadminbaik.pteroqdactyl.my.id:11560/deleteUser?key=$sessionKey&username=$username'));
      final data = jsonDecode(res.body);
  ...
  Future<void> _createAccount() async {
    ...
    try {
      final res = await http.get(Uri.parse(
          'http://tirzzadminbaik.pteroqdactyl.my.id:11560/userAdd?key=$sessionKey&username=$username&password=$password&day=$day&role=$newUserRole'));
      final data = jsonDecode(res.body);
