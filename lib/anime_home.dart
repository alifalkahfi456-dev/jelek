...
final Color mainViolet = const Color(0xFF040F22);   
final Color accentViolet = const Color(0xFFEA80FC);  
final Color bgBlack = const Color(0xFF020818);   
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [Color(0xFF020818), deepViolet.withOpacity(0.4)],
                  begin: Alignment.topLeft,
                  end: Alignment.bottomRight,
                ),
                border: Border.all(color: mainViolet.withOpacity(0.5)),
                boxShadow: [
                  BoxShadow(color: deepViolet.withOpacity(0.2), blurRadius: 15, offset: Offset(0, 5)),
                ],
              ),
              child: Row(
                children: [
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: Color(0xFF020818).withOpacity(0.5), blurRadius: 5)],
        ),
        child: ClipRRect(
          borderRadius: BorderRadius.circular(15),
          child: Stack(
            children: [
              ...
              Positioned.fill(
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      colors: [Colors.transparent, Color(0xFF020818).withOpacity(0.95)],
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text(anime.score.toString(), style: TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
                      ],
                    ),
                  ),
                ),
              Positioned(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(anime.title, maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
  ...
  Widget _buildShimmerGrid() {
    return Shimmer.fromColors(
      ...
      child: GridView.builder(
        ...
        itemCount: 6,
        itemBuilder: (_, __) => Container(decoration: BoxDecoration(color: Color(0xFF020818), borderRadius: BorderRadius.circular(15))),
      ),
    );
  }
}
                    ...
                    child: ElevatedButton(
                      ...
                      child: Ink(
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(15),
                          boxShadow: [
                            BoxShadow(color: mainViolet.withOpacity(0.5), blurRadius: 10, offset: Offset(0, 4))
                          ]
                        ),
                        child: Container(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 10),
                          Text(_errorMsg!, textAlign: TextAlign.center, style: TextStyle(color: Colors.white70)),
                        ],
                      ),
                    )
                  else
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18, fontFamily: 'Orbitron'),
                    ),
                    Text(widget.anime.title, style: TextStyle(color: Colors.white54, fontSize: 14)),
