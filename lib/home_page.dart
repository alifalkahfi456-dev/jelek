                  ...
                  builder: (context, _) {
                    return Transform.scale(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Icon(FontAwesomeIcons.userSecret, color: _glowColor1.withOpacity(0.8), size: 32),
                        ),
                      ),
                    );
                  },
            ...
            Row(
              children: [
                Container(
                  ...
                  child: const Icon(FontAwesomeIcons.bug, color: Color(0xFFE0E0F8), size: 20),
                ),
                const SizedBox(width: 12),
                Text(
                  "BUG ARSENAL",
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: _isLoadingSenders
                        ? const SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFFE0E0F8)))
  ...
  Widget _buildFooter() {
    return Column(
      children: [
        ...
        Text(
          "DEATHXRAT v1.0  •  ADVANCED SECURITY PROTOCOL",
          style: TextStyle(
