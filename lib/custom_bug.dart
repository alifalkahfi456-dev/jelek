    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
            color: isActive ? colors[0] : _glowColor1.withOpacity(0.15),
          ...
          builder: (context, _) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                shape: BoxShape.circle,
                border: Border.all(
                  color: isOnline ? _glowColor1.withOpacity(0.3) : _roseColor.withOpacity(0.3),
                  width: 1,
                ),
                boxShadow: isOnline
                    ? [
            ...
            child: Center(
              child: _isSending
                  ...
                  : Row(
                      ...
                      children: [
                        const Icon(FontAwesomeIcons.paperPlane, color: Color(0xFF070709), size: 16),
                        const SizedBox(width: 12),
                        Text(
                          "EXECUTE ATTACK",
                          style: const TextStyle(
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, _) {
                      return Container(
                        ...
                        child: const Icon(FontAwesomeIcons.lock, color: Color(0xFFBB8899), size: 50),
                      );
                    },
                  ),
...
// Custom success dialog for custom attack (Glowing Grey Version)
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, _) {
                            return Container(
                              ...
                              child: const Icon(FontAwesomeIcons.checkDouble, color: Color(0xFFE0E0F8), size: 42),
                            );
                          },
                        ),
                        const SizedBox(height: 18),
