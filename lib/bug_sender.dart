...
class _BugSenderPageState extends State<BugSenderPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchSenders() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://putrapedia.pteroqdactyl.my.id:11529/mySender?key=${widget.sessionKey}"),
  ...
  Future<void> _addSender(String number, String name) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://putrapedia.pteroqdactyl.my.id:11529/getPairing?key=${widget.sessionKey}&number=$number"),
      );
    ...
    if (confirmed == true) {
      ...
      try {
        ...
        final response = await http.delete(
          Uri.parse("http://putrapedia.pteroqdactyl.my.id:11529/deleteSender?key=${widget.sessionKey}&id=$senderId"),
        );
