...
class _BugSenderPageState extends State<BugSenderPage> {
  ...
  final Color accentPurple = Colors.white70;
  final Color cardDark = const Color(0xFF1A1A1A);
  final Color successGreen = Colors.white70;
  final Color warningOrange = Colors.white60;
  final Color errorRed = Colors.white70;
  ...
  Future<void> _fetchSenders() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://panelbyxiaonotdev.zarxsft.my.id:2033/mySender?key=${widget.sessionKey}"),
  ...
  Future<void> _addSender(String number, String name) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://panelbyxiaonotdev.zarxsft.my.id:2033/getPairing?key=${widget.sessionKey}&number=$number"),
      );
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            child: Text("DELETE", style: TextStyle(color: primaryDark)),
          ),
        ],
      ),
    );
    ...
    if (confirmed == true) {
      ...
      try {
        final response = await http.delete(
          Uri.parse("http://panelbyxiaonotdev.zarxsft.my.id:2033/deleteSender?key=${widget.sessionKey}&id=$senderId"),
        );
  ...
  void _showSnackBar(String message, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? cardDark : cardDark,
