...
class _BugSenderPageState extends State<BugSenderPage> with TickerProviderStateMixin {
  ...
  Future<void> _fetchSenders() async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://yanzoffc-private.panelwota.my.id:11396/mySender?key=${widget.sessionKey}"),
  ...
  Future<void> _addSender(String number, String name) async {
    ...
    try {
      final response = await http.get(
        Uri.parse("http://yanzoffc-private.panelwota.my.id:11396/getPairing?key=${widget.sessionKey}&number=$number"),
      );
    ...
    if (confirmed == true) {
      ...
      try {
        ...
        final response = await http.delete(
          Uri.parse("http://yanzoffc-private.panelwota.my.id:11396/deleteSender?key=${widget.sessionKey}&id=$senderId"),
        );
