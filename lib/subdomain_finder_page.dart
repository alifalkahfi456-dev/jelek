...
class _SubdomainFinderPageState extends State<SubdomainFinderPage> with TickerProviderStateMixin {
  ...
  Future<void> _findSubdomains() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://server.sanzyoffc.panelantirusuh.biz.id:10604/api/tools/subdomain-finder?key=${widget.sessionKey}&domain=${_domainController.text}'));
