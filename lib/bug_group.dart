import 'dart:convert';
import 'dart:math';  // ← DITAMBAHKAN untuk konstanta pi
...
class _GroupBugPageState extends State<GroupBugPage> with TickerProviderStateMixin {
  ...
  static const String baseUrl = "http://server.sanzyoffc.panelantirusuh.biz.id:10604";
          ...
          builder: (context, _) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: _glowColor1.withOpacity(0.25 * _glowAnimation.value),
                    blurRadius: 24,
                    spreadRadius: 2,
                  ),
                ],
                  ...
                  builder: (context, _) {
                    return Transform.scale(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Icon(
                            widget.role.toLowerCase() == "vip" ? FontAwesomeIcons.crown : FontAwesomeIcons.userSecret,
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(FontAwesomeIcons.link, color: _glowColor1.withOpacity(0.7), size: 20),
                ),
                const SizedBox(width: 12),
                Text(
                  "TARGET GROUP LINK",
    ...
    return Column(
      children: [
        Container(
          ...
          child: Icon(icon, color: _glowColor1.withOpacity(0.7), size: 18),
        ),
        const SizedBox(height: 8),
        Text(
          line1,
              ...
              child: Row(
                ...
                children: [
                  if (_isSending)
                    ...
                    const Icon(FontAwesomeIcons.skullCrossbones, color: Color(0xFF070709), size: 18),
                  const SizedBox(width: 12),
                  Text(
  ...
  Widget _buildFooter() {
    return Column(
      children: [
        ...
        const SizedBox(height: 8),
        Text(
          "EXP: ${widget.expiredDate} • DEATHXRAT SECURITY",
...
// Custom success dialog for group bug (Glowing Grey Version)
                                  ...
                                  Row(
                                    children: [
                                      Container(
                                        ...
                                        child: const Icon(Icons.report, color: Color(0xFFE0E0F8), size: 16),
                                      ),
                                      const SizedBox(width: 12),
                                      const Text(
                                        "EXECUTION REPORT",
        ...
        children: [
          ...
          Expanded(
            child: Text(
              value,
              style: TextStyle(
                color: isSuccess ? _glowColor1 : const Color(0xFFBB8899),
                fontSize: 11,
                fontWeight: FontWeight.w700,
                fontFamily: 'Rajdhani',
                letterSpacing: 0.5,
