        ...
        actions: [
          TextButton.icon(
            ...
            onPressed: () async {
              ...
              final uri = Uri.parse("tg://resolve?domain=hidenxvinzz");
              if (await canLaunchUrl(uri)) {
                await launchUrl(uri, mode: LaunchMode.externalApplication);
              } else {
                await launchUrl(Uri.parse("https://t.me/hidenxvinzz"),
          ...
          TextButton.icon(
            ...
            onPressed: () async {
              Navigator.pop(context);
              final uri = Uri.parse(
                  "https://wa.me/6289530521021?text=Hello%20I%20want%20to%20buy%20$plan");
              if (await canLaunchUrl(uri)) {
                await launchUrl(uri, mode: LaunchMode.externalApplication);
              }
            },
