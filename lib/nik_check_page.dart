...
class _NIKCheckPageState extends State<NIKCheckPage> {
  ...
  Future<void> _checkNIK() async {
    ...
    try {
      final response = await http.get(Uri.parse('http://server.sanzyoffc.panelantirusuh.biz.id:10604/api/tools/nik-check?key=${widget.sessionKey}&nik=${_nikController.text}'));
